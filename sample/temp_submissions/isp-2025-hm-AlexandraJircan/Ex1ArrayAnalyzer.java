...
public class Ex1ArrayAnalyzer {
    ...
    public static void main(String[] args) {
        ...
        int[] randomArray= ex1ArrayAnalyzer.generateArray();
        double average= ex1ArrayAnalyzer.calculateAverage(randomArray);
        int[] countAboveBelow= ex1ArrayAnalyzer.countAboveBelowAverage(randomArray,average);
        System.out.println("above average"+countAboveBelow[0]);
        System.out.println("below average"+countAboveBelow[1]);
