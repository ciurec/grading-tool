...
public class Ex1ArrayAnalyzer {
    ...
    public static void main(String[] args) {
        ...
        int[] random_numbers_array = ex1ArrayAnalyzer.generateArray();
        double average = ex1ArrayAnalyzer.calculateAverage(random_numbers_array);
        int[] countAboveBelowAvarage = ex1ArrayAnalyzer.countAboveBelowAverage(random_numbers_array, average);
        System.out.println("Above average numbers : " + countAboveBelowAvarage[0]);
        System.out.println("Below average numbers : " + countAboveBelowAvarage[1]);
